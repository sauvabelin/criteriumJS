<template>
    <div>
        <div class="container-fluid">
            <div class="row mb-3">
                <div class="col-3">
                    ...
                    <a-input v-model="bonusSeconds" placeholder="Bonus en secondes" />
                </div>
                <div class="col-3">
        ...
        <a-table :columns="columns" :dataSource="resultatsSousUnites" rowKey="id" />
    </div>
</template>
    ...
    computed: {
        ...
        resultatsSousUnites() {
            ...
            return this.sousUnite.map(id => ({
                ...
                ...rest2,
                bonus: rest2.participants.length * bonuuus,
            })).map(rest3 => ({
                ...rest3,
